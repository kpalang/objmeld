 ...
 */
public class OgnlBufferDiffPanel extends AbstractContentPanel implements DiffPanelIF {
    ...
    public OgnlBufferDiffPanel(JPanel mainPanel, boolean flexible) {
...
//        add(splitPane);
    ...
    private JPanel buildFilePanel(String columns, String rows) {
        ...
        if(flexible) {
            filePanel.setMinimumSize(mainPanel.getSize());
